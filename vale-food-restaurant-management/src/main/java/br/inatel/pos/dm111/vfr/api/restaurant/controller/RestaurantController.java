...
public class RestaurantController {
	...
	public ResponseEntity<RestaurantResponse> getUserById(@PathVariable("restaurantId") String id) throws ApiException {
	...
	public ResponseEntity<RestaurantResponse> putUser(@RequestBody RestaurantRequest request,
			@PathVariable("restaurantId") String restaurantId, BindingResult bindingResult) throws ApiException {
