...
public class UserController {
	...
	// }
	@PostMapping
	public ResponseEntity<UserResponse> postUser(@RequestBody UserRequest request, BindingResult bindingResult)
			throws ApiException {
	...
	public ResponseEntity<UserResponse> putUser(@RequestBody UserRequest request, @PathVariable("userId") String userId,
